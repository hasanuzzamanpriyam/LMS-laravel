            ...
            <div class="main-body">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('storage/'.$category->image) }}" class="form-control" id="photoPreview" width="20" height="160" style="margin-top: 15px; " />
                            </div>
